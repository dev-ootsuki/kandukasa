    ...
    <div class="content-main q-pa-sm">
      <q-form autocorrect="off" autocapitalize="off" autocomplete="off">
        <div>
          ...
          <!-- db_type -->
          <pf-select require icon="settings_applications" :label="$t('settings.db_connections.db_type')" :validate="[qRequired, qLengthTo32]" :model="input" ref="input.db_type" :options="Domain.DatabaseProducts"/>
          <!-- host -->
